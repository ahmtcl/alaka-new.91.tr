  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        <h1 className="text-white text-2xl font-light tracking-wider">Upcoming Yönetimi</h1>
        <button
              ...
              <div className="flex items-center gap-4">
                <div>
                  <div className="flex items-center gap-2">
                    ...
                    {!item.active && (
                      <span className="text-[10px] bg-red-500/20 text-red-400 px-2 py-0.5 rounded uppercase tracking-wider">Pasif</span>
                    )}
                  </div>
                  <p className="text-white/40 text-sm mt-1">Sıra: {item.order}</p>
                </div>
              </div>
